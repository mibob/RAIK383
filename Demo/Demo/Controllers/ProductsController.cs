...
namespace Demo.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Size,Color,Brand,AddedOn")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Size,Color,Brand,AddedOn")] Product product)
        {
            if (ModelState.IsValid)
            {
